...
### Diamond Problem
### Deep Inheritance Hierarchy Smells

## Composition as a Flexible Alternative

### Delegation Pattern
### Mixins and Traits
### Behavioral Composition via Higher-Order Functions

## Interface- and Type-Based Design

### Protocol / Interface-Based Design
### Duck Typing as Composition
### Type Classes / Traits in FP
